...
public class RuleMessageInfo extends RuleMessage {
    ...
    public RuleMessageInfo(String language, String ruleName, String comment, String expectedValue, String parent, String fieldName, Object object, Map<String, String> context) {
