...
public class RuleMessageWarning extends RuleMessage {
    ...
    public RuleMessageWarning(String language, String ruleName, String comment, String expectedValue, String parent, String fieldName, Object object, Map<String, String> context) {
