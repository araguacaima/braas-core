 ...
 */
public class KieStatefulDecisionTableSessionImpl implements KieSessionImpl {
    private final KieSession statefullSession;

    public KieStatefulDecisionTableSessionImpl(KieSession kieSession, boolean verbose, Map<String, Object> globals) {
