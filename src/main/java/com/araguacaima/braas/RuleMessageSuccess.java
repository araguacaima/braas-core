...
public class RuleMessageSuccess extends RuleMessage {
    ...
    public RuleMessageSuccess(String language, String ruleName, String comment, String expectedValue, String parent, String fieldName, Object object, Map<String, String> context) {
